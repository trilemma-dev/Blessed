# ``Blessed``
A Swift friendly implementation of SMJobBless with excellent error messages.
...
## Sandboxing
> Warning: This package is *not* available to sandboxed processes because of privilege escalation.

If you need to determine at run time if your process is sandboxed, this package adds a property to
